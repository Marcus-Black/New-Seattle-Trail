...
public static CrewMember chooseMember() {
	int choice = Probability.RandomUpperLower(1, Crew.CrewAlive + 1);
	return Crew.Team.get(choice);
}
public static boolean perceptionBasedChance(double perceptiveness) {
	boolean result;
	result = SpecificPercentChance((100 - perceptiveness));
	return result;
}
