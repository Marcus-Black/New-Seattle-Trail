...
public class NPC extends Entity {
	...
	public enum Title{
		LAME,BORING,TERRIBLE,AMAZING,FANTASTIC,INCREDIBLE,SHORT_SIGHTED,GENIUS
	}
...
//		sb.append("Hello Travelers, my name is " + this.name + " I am just a " + this.ageRange + " " + this.gender + " searching for " + equipment + ". If you happen to trade with me I am willing to trade you for other goods that you may need." + " If you would like I can also come with you on the trail?");
		return sb.toString();
	}
